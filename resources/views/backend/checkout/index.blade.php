                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            @foreach ($checkout as $offer)
                            <tr>
                                <td>{{ $offer->name}}</td>
                                <td>{{ $offer->email}}</td>
                                <td>{{ $offer->mobile}}</td>
                                <td>{{ $offer->offer->title}} / ({{$offer->quantity}})</td>
                                <td>{{ $offer->address}}</td>
                                {{-- <td><a href="{{ route('admin.checkout.show',$offer->id)}}" class="d-flex align-items-center theme-icons shadow-sm p-2 cursor-pointer rounded">

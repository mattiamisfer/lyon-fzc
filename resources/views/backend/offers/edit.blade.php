    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="card border-top border-0 border-4 border-danger">
                ...
                {{ Aire::open()
                    ->route('admin.offers.update', $offer->id)
                    ->bind($offer)
                    ->put() }}
...
->type('text') }}
                ...
                <div class="row">
                    ...
                    {{
                        Aire::date('date_input', 'Choose a Valid Date')
                        ->value($offer->validation)
                        ->groupClass('col-md-6');
                    }}
...
@enderror --}}
                    ...
                    <input type="hidden" name="current_image" value="{{$offer->image}}">
                    ...
                    {{
                        ...
                        ->groupClass('col-md-6')->value($offer->status);
                    }}
                    ...
                    <div class="col-md-6">
                        {{
                            Aire::submit('Update') ->addClass('btn btn-success  form-control  mt-4 ');

    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="card border-top border-0 border-4 border-danger">
                ...
                {{ Aire::open()
                    ->route('admin.vasthu.update', $vasthu->id)
                    ->bind($vasthu)
                    ->put() }}
...
@enderror --}}
                    ...
                    <input type="hidden" name="current_image" value="{{$vasthu->image}}">
                    ...
                    {{
                        ...
                        ->groupClass('col-md-6')->value($vasthu->status);
                    }}

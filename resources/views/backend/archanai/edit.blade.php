    ...
    <div class="page-content">
        ...
        <div class="row">
            <div class="card border-top border-0 border-4 border-danger">
                ...
                {{ Aire::open()
                    ->route('admin.archanai.update', $archanai->id)
                    ->bind($archanai)
                    ->put() }}
...
->value($archanai->title)
->type('text') }}

                <div class="row">
                    {{
                        Aire::select($categorylist, 'category_id', 'Category')->value($archanai->category_id)
                        ->groupClass('col-md-6');
...
@enderror --}}
                    ...
                    <input type="hidden" name="current_image" value="{{$archanai->image}}">
                    ...
                    {{
                        ...
                        ->groupClass('col-md-6')->value($archanai->status);
                    }}

                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            @foreach ($homams as $homam)
                            <tr>
                                <td>{{ $homam->title}}</td>
                                <td><a href="{{ route('admin.homam.edit',$homam->id)}}" class="d-flex align-items-center theme-icons shadow-sm p-2 cursor-pointer rounded">
                                    <div class="font-22 text-primary">	<i class="fadeIn animated bx bx-message-edit"></i>
                                    </div>
                                    <div class="ms-2">Edit</div>
                                </a></td>
                                <td>
                                    <form action="{{ route('admin.homam.destroy', $homam->id) }}" method="POST">

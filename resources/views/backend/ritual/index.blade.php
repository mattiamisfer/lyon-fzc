...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.ritual.create')}}" class="d-flex align-items-center theme-icons shadow-sm p-2 cursor-pointer rounded">
                ...
                <div class="table-responsive">
                    <table id="example2" class="table table-striped table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $ritual->title}}</td>
                                <td><a href="{{ route('admin.ritual.edit',$ritual->id)}}" class="d-flex align-items-center theme-icons shadow-sm p-2 cursor-pointer rounded">
                                    <div class="font-22 text-primary">	<i class="fadeIn animated bx bx-message-edit"></i>
                                    </div>
                                    <div class="ms-2">Edit</div>
                                </a></td>
                                <td>
                                    <form action="{{ route('admin.ritual.destroy', $ritual->id) }}" method="POST">
